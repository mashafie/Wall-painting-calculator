...
export function validateYesNoInput(value) {
...
export async function askNumberOfRooms() {
    const response = await inquirer.prompt({
        name: 'rooms',
        type: 'input',
...
export async function askNumberOfWalls(roomNumber) {
    const response = await inquirer.prompt({
        name: 'walls',
        type: 'input',
...
;
export async function createWall(wallNumber) {
