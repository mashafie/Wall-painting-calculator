...
export function calculateTotalLitres(user) {
...
export function recommendation(totalLitres) {
...
;
export function createTables(totalLitres, recommendations, totalAmount) {
    // First table
    console.log();
