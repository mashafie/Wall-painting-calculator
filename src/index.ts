...
function recommendation(totalLitres: { [key: string]: number }) {
...
function createTables(totalLitres: { [key: string]: number}, recommendations: { [key: string]: [size: number, price: number][] }, totalAmount: number) {
    // First table
    console.log();
